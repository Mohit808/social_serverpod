...
import '../endpoints/like_endpoint.dart' as _i5;
import '../endpoints/map_endpoint.dart' as _i6;
import '../endpoints/poll_endpoint.dart' as _i7;
import '../endpoints/post_endpoint.dart' as _i8;
import '../endpoints/saved_post_endpoint.dart' as _i9;
import '../endpoints/story_endpoint.dart' as _i10;
import '../endpoints/tag_endpoint.dart' as _i11;
import '../endpoints/user_endpoint.dart' as _i12;
import '../endpoints/user_profile_endpoint.dart' as _i13;
import '../endpoints/vote_endpoint.dart' as _i14;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'savedPost': _i9.SavedPostEndpoint()
        ..initialize(
          server,
          'savedPost',
          null,
        ),
      'story': _i10.StoryEndpoint()
        ..initialize(
          server,
          'story',
          null,
        ),
      'tag': _i11.TagEndpoint()
        ..initialize(
          server,
          'tag',
          null,
    ...
    connectors['like'] = _i1.EndpointConnector(
      name: 'like',
      endpoint: endpoints['like']!,
      methodConnectors: {
        'likePost': _i1.MethodConnector(
          name: 'likePost',
          params: {
            'post_id': _i1.ParameterDescription(
              name: 'post_id',
              type: _i1.getType<String?>(),
              nullable: true,
            ),
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['like'] as _i5.LikeEndpoint).likePost(
                session,
                params['post_id'],
              ),
        ),
        ...
        'getMapData': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['map'] as _i6.MapEndpoint).getMapData(
                session,
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['poll'] as _i7.PollEndpoint).getPolls(session),
        ),
        'createPoll': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['poll'] as _i7.PollEndpoint).createPoll(
                session,
        ...
        'deletePoll': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['poll'] as _i7.PollEndpoint).deletePoll(
                session,
      ...
      methodConnectors: {
        'getPosts': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['post'] as _i8.PostEndpoint).getPosts(
                session,
                city: params['city'],
                tags: params['tags'],
        ...
        'createPost': _i1.MethodConnector(
          ...
          params: {
            ...
            'peopleTaqqed': _i1.ParameterDescription(
              name: 'peopleTaqqed',
              type: _i1.getType<List<String>?>(),
              nullable: true,
            ),
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['post'] as _i8.PostEndpoint).createPost(
                session,
                text: params['text'],
                image: params['image'],
                ...
                pollId: params['pollId'],
                tags: params['tags'],
                peopleTaqqed: params['peopleTaqqed'],
              ),
        ),
      },
    );
    connectors['savedPost'] = _i1.EndpointConnector(
      name: 'savedPost',
      endpoint: endpoints['savedPost']!,
      methodConnectors: {
        'toggleSavePost': _i1.MethodConnector(
          name: 'toggleSavePost',
          params: {
            'post_id': _i1.ParameterDescription(
              name: 'post_id',
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['savedPost'] as _i9.SavedPostEndpoint)
                  .toggleSavePost(
                    session,
                    post_id: params['post_id'],
                  ),
        ),
        'getSavedPosts': _i1.MethodConnector(
          name: 'getSavedPosts',
          params: {
            'page': _i1.ParameterDescription(
              name: 'page',
        ...
        'checkIfPostSaved': _i1.MethodConnector(
          name: 'checkIfPostSaved',
          params: {
        ...
        'getSavedPostsCount': _i1.MethodConnector(
          name: 'getSavedPostsCount',
          params: {},
          call:
              (
                _i1.Session session,
    ...
    connectors['story'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'createStory': _i1.MethodConnector(
          name: 'createStory',
          params: {
            'media_url': _i1.ParameterDescription(
              name: 'media_url',
              type: _i1.getType<String>(),
              nullable: false,
            ),
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['story'] as _i10.StoryEndpoint).createStory(
                session,
        ...
        'getStories': _i1.MethodConnector(
          name: 'getStories',
          params: {
            'page': _i1.ParameterDescription(
              name: 'page',
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['story'] as _i10.StoryEndpoint).getStories(
                session,
                page: params['page'],
              ),
        ),
        'deleteStory': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['story'] as _i10.StoryEndpoint).deleteStory(
                session,
                params['storyId'],
              ),
        ),
    ...
    connectors['tag'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'getTags': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['tag'] as _i11.TagEndpoint).getTags(
                session,
                search: params['search'],
                noImage: params['noImage'],
                hideCount: params['hideCount'],
        ...
        'getTagById': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['tag'] as _i11.TagEndpoint).getTagById(
                session,
                params['id'],
              ),
        ),
        'createTag': _i1.MethodConnector(
          name: 'createTag',
          params: {
            'tagData': _i1.ParameterDescription(
              name: 'tagData',
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['tag'] as _i11.TagEndpoint).createTag(
                session,
                params['tagData'],
              ),
        ),
        'updateTag': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['tag'] as _i11.TagEndpoint).updateTag(
                session,
                params['id'],
                params['tagData'],
              ),
        ...
        'deleteTag': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['tag'] as _i11.TagEndpoint).deleteTag(
                session,
                params['id'],
              ),
        ),
        ...
        'getUser': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['user'] as _i12.UserEndpoint).getUser(
                session,
                params['userId'],
              ),
        ),
        'createUser': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['user'] as _i12.UserEndpoint).createUser(
                session,
                params['name'],
                params['image'],
              ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['user'] as _i12.UserEndpoint).getAllUsers(session),
        ),
      },
    );
        ...
        'vote': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['vote'] as _i14.VoteEndpoint).vote(
                session,
