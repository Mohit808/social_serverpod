...
--
-- Class CommentReport as table comment_reports
--
...
--
-- Class LikeComment as table like_comments
--
...
--
-- Class PollVote as table poll_votes
--
...
--
-- Class PostPeopleTagged as table post_people_tagged
--
...
--
-- Class PostReport as table post_reports
--
...
--
-- Class PostTag as table post_tags
--
...
--
-- Class PostViewCount as table post_view_counts
--
...
--
-- Class ReplyComment as table reply_comments
--
...
--
-- Class SavedPost as table saved_posts
--
...
--
-- Class StoryViewCount as table story_view_counts
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('social_serverpod', '20260130091544562', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260130091544562', "timestamp" = now();
